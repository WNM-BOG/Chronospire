# Chronospire
## Код для улучшения функционала игры:
```python
import random
import time
import sys
...
def show_intro():
    ...
    print()
    print_slow("Теперь ты поднимаешься по Хроноспирали - лестнице, соединяющей миры и времена.")
    ...
    print_slow("Судьба вселенной висит на волоске, и только ты можешь ее спасти...")
    print()
